...
class Player(Character):
    ...
    def __init__(self,name='test',max_hp= 10,attack=2,defense=3,dice = Dice(6), texture_creation='guerrier', move_left_choice='a', move_right_choice='d', jump_choice='space',attack_choice = 'w'):
        super().__init__(name=name, max_hp=max_hp, attack=attack, defense=defense, dice=dice, texture_creation=texture_creation)
